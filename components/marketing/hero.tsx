      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 pb-24 pt-20 sm:px-8 lg:grid-cols-[0.92fr_1.08fr] lg:gap-10 lg:pb-32 lg:pt-28">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            ClearMate uses AI to explain medical reports, electricity bills and bank notices in simple language.
          </p>
          <div id="upload" className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Button href="#how-it-works" className="gap-2">
              Upload Document <ArrowRight className="size-4" aria-hidden="true" />
            </Button>
